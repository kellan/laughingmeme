...
David Bessis's ["The fall of the theorem economy"](https://davidbessis.substack.com/p/the-fall-of-the-theorem-economy) is ostensibly about LLMs and pure math, and I found it fascinating in it its own right, even while I'm not qualified to evaluate a number of his claims. Worth stopping and reading.
...
_“The product of mathematics is clarity and understanding. Not theorems, by themselves.”_  
—Bill Thurston

Bessis makes the argument that mathematics has publicly been valuing proving theorems as the high status work, while systematically undervaluing and disguising the critical roles that creativity, community, clarity, and teaching play in advancing the field. Critical work got done without anyone explicitly setting out to do it as an unacknowledged by product of the system of human production. Now with the advent of LLM powered theorem provers the theorem proving can happen in absence of those critical side effects.  

"definitions are worth zero points, expository work counts negative, and the best jobs should always go to the people who proved the hardest theorems."
...
Don't love Bessis' coining of "intuition-maxxers", but I'm absolutely familiar with and excited about the people "seeing further than anyone before, standing on the shoulders of giant machines."

But if we're not careful, the [Cognitive Surplus](https://en.wikipedia.org/wiki/Cognitive_Surplus) becomes the Cognitive Seed Corn (as in the eating of, credit [Migurski](http://mike.teczno.com/notes/)). If we continue to value only the work of theorem proving (coding) and not the work of canonizing (and also training the next generation of practitioners) than the Overhang will grow increasingly poor as a search space. We see this already in how reviewing is more fatiguing and also unrewarded. No one gets status for doing clean up. (see Tanya's [glue work](https://www.noidea.dog/glue))

Generation easy. Canonization hard. Intuition and social product of knowledge a thing not to lose in the rush to automation.